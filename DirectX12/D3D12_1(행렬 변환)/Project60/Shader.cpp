...
{
	return(CShader::CompileShaderFromFile(L"Shader/Shaders.hlsl", "VSLighting", "vs_5_1", &m_pd3dVertexShaderBlob));
}

D3D12_SHADER_BYTECODE CIlluminatedShader::CreatePixelShader()
{
	return(CShader::CompileShaderFromFile(L"Shader/Shaders.hlsl", "PSLighting", "ps_5_1", &m_pd3dPixelShaderBlob));
}
